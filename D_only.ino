...
// Servo adjustment
#define _DUTY_NEU 1720  // Servo angle: 0 degree
...
void loop()
{
  ...
  if(event_dist) {
    ...
    dist_filtered = volt_to_distance(ir_sensor_filtered(1, 0.5));
...
{
  return 434 + -1.24*a_value + 9E-04*a_value*a_value; // Replace this with the equation obtained from nonlinear regression analysis
}
