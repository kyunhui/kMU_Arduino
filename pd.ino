...
void loop()
{
  ...
  if(event_dist) {
    ...
    dist_filtered = volt_to_distance(ir_sensor_filtered(13, 0.5));
...
//return 434 + -1.24*a_value + 9E-04*a_value*a_value;
