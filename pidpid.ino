...
#define _EMA_ALPHA 0.89    // EMA weight of new sample (range: 0 to 1)

// Servo adjustment
#define _DUTY_NEU 1678 // 1550 , 1650 
#define _DUTY_MIN 750 // 750 , 920
#define _DUTY_MAX 2534 // 2134 ,2400
#define _SERVO_ANGLE_DIFF 90 // servo angle difference between _DUTY_MIN and _DUTY_MAX (unit: degree) //90 120
#define _SERVO_SPEED 115 // servo speed limit (unit: degree/second) //100 50

// PID parameters
#define _DIST_TARGET 155 // center of the rail (unit: mm)
#define _KP 4.56 // proportional gain //5 2
#define _KD 358 // derivative gain //550 520
#define _KI 0.0022 // integral gain //0.007 0.001
...
{
  return 643 + -2.23*a_value + 1.94E-03*a_value*a_value; // Replace this with the equation obtained from nonlinear regression analysis
}
//638 + -2.21x + 1.91E-03x^2
//643 + -2.23*a_value + 1.94E-03*a_value*a_value
//434 + -1.24*a_value + 9E-04*a_value*a_value;
//685 + -2.4*a_value + 2.1E-03*a_value*a_value;
